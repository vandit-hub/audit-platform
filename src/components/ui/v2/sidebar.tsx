...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "bg-background relative flex w-full flex-1 flex-col transition-[padding] duration-200",
        "md:pl-[var(--sidebar-width)]",
        "md:peer-data-[state=collapsed]:pl-[var(--sidebar-width-icon)]",
        "md:peer-data-[collapsible=offcanvas]:pl-0",
